        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalDistrictId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Patients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Patients_Districts_MedicalDistrictId",
                        column: x => x.MedicalDistrictId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctors_MedicalDistrictId",
                table: "Doctors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_MedicalDistrictId",
                table: "Patients",
                column: "MedicalDistrictId");
        }
